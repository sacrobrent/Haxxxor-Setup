...
echo -e "██║░░██║╚██████╔╝██║░╚███║░░░██║░░░███████╗██║░░██║"
echo -e "╚═╝░░╚═╝░╚═════╝░╚═╝░░╚══╝░░░╚═╝░░░╚══════╝╚═╝░░╚═╝"
echo -e "Facebook: https://www.facebook.com/Hey.Son.Its.Your.Papppa.E8A6.A5.M2H6U3.I7F2N"
...
figlet 'BANNER'
echo -e ""
git clone https://github.com/noobboss1/TermuxBanner; cd TermuxBanner; bash setup.sh
fi
if [ $set = 6 ] || [ $set = 06 ]
then
clear
...
figlet 'Update Tool'
rm -rf NoobSetup
git clone https://github.com/noobboss1/NoobSetup; cd NoobSetup; bash start.sh
fi
if [ $set = 8 ] || [ $set = 08 ]
then
clear
figlet 'Termux'
figlet 'Hunter'
xdg-open 'https://www.facebook.com/Hey.Son.Its.Your.Papppa.E8A6.A5.M2H6U3.I7F2N'
fi
if [ $set = 0 ] || [ $set = 00 ]
then
clear
